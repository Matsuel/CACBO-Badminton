export const textVariants = {
    h1: "font-Darker-Grotesque text-[58px] leading-[40px] font-bold",
    h2: "font-Space-Grotesk text-[25px] leading-[20px] font-bold",
    h3: "font-Space-Grotesk text-[21px] leading-[20px] font-bold",
