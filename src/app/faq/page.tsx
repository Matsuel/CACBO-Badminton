...
const Faq = () => {
    return (
        <PageLayout
            ...
            icon={Bubble}
        >
            <Bloc title='1.  Quelles sont les créneaux horaires d’entraînement ?' className='mt-0'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='2.  Où se déroulent les créneaux ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='3.  Le club est-il ouvert à tous les niveaux ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title="4.  Puis-je venir essayer avant de m'inscrire ?" className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='5.  Quel est le tarif pour adhérer au club ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='6.  Utilisez-vous des volants en plumes ou en nylon ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='7.  Faut-il ramener son propre matériel ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='8.  Puis-je acheter des volants directement au club ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='9.  Y a-t-il une limite d’âge pour s’inscrire ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='10.  Proposez-vous des cours encadrés ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='11.  Organisez-vous des événements en dehors des créneaux ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title='12.  Combien de terrains sont disponibles pendant les créneaux ?' className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title="13.  Comment m’inscrire au club ?" className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title="14.  Puis-je venir jouer en dehors des créneaux horaires ?" className='mt-20'>
                <BlocFull>
                    <Paragraphe>
            ...
            <Bloc title="15.  Comment puis-je vous contacter pour plus d’informations ?" className='mt-20'>
                <BlocFull>
                    <Paragraphe>
