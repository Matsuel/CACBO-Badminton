    ...
    return (
        <div className={`w-full flex flex-col items-center min-h-screen bg-whitebroken`}>
            ...
            <div className="w-[39%] h-auto mt-28 mb-36 flex flex-col relative">
                ...
                <p className="w-[85%] font-Inter font-light tracking-tight leading-10 line italic text-xl text-wrap text-center relative z-10">
                ...
                <div
                    className="font-SourceSerifPro text-9xl text-white text-center absolute bottom-[-35px] right-[200px] z-0">
                    »
                </div>
            </div>
            ...
            <div className="w-[80%] h-auto flex flex-col items-start justify-center gap-5">
                ...
                <div className="w-[100%] h-auto flex flex-row items-start justify-center gap-32">
                    ...
                    <div
                        ...
                        <p className="w-[60%] font-Inter font-light leading-5 text-base text-center mb-3">
